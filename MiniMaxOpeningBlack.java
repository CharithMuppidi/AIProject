...
public class MiniMaxOpeningBlack {
	...
	public MiniMaxOpeningBlack(String currentBoard, int depth) 
	{
	...
	/**
	 *  generates moves created by adding a black piece 
	...
	public static void main(String[] args) {
		...
		try {
			...
			try (Scanner scan = new Scanner(fish)) {
				...
				MiniMaxOpeningBlack bStart = new MiniMaxOpeningBlack(board, depth);
				String bob = new String(bStart.newBoard);
				System.out.println("Board Position: " + bob);
				System.out.println("Positions evaluated by static estimation: " + bStart.pos_eval);
				System.out.println("MINIMAX estimate: " + bStart.stat_est);
				otter.write(bob);
			}
			fish.close();
			otter.close();
