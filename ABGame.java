...
public class ABGame {
	...
	public ABGame(String currentBoard, int depth) 
	{
	...
	public static void main(String[] args) {
		...
		try {
			...
			try (Scanner scan = new Scanner(fish)) {
				...
				ABGame abed = new ABGame(board, depth);
				String bob = new String(abed.newBoard);
				System.out.println("Board Position: " + bob);
				System.out.println("Positions evaluated by static estimation: " + abed.pos_eval);
				System.out.println("MINIMAX estimate: " + abed.stat_est);
				otter.write(bob);
			}
			fish.close();
			otter.close();
